...
Russian is the canonical language for operational documents (HOT, NEXT,
DECISIONS, VP reports, commits). Stable docs are maintained as RU/EN pairs and
updated together when the public contract changes (Master Spec §9).
